...
<!-- Mirrored from templates.iqonic.design/vito/html/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 14:21:07 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="{{asset('assets/images/npontulogo.png')}}" />
      <!-- Bootstrap CSS -->
         ...
         <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
               ...
               <div class="iq-light-logo">
                  <div class="iq-light-logo">
                     <img src="{{asset('assets/images/npontulogo.png')}}" class="img-fluid" alt="">
                   </div>
                     <div class="iq-dark-logo">
                        <img src="{{asset(path: 'assets/images/npontulogo.png')}}" class="img-fluid" alt="">
                     </div>
               </div>
               <div class="iq-dark-logo">
                  <img src="{{asset(path: 'assets/images/npontulogo.png')}}" class="img-fluid" alt="">
               </div>
               <span>Nponto Technologies </span>
               </a>
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        <li class="nav-item">
                           <a class="search-toggle iq-waves-effect language-title" href="#"><img src="{{asset(path: 'assets/images/small/flag-01.png')}}" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> English <i class="ri-arrow-down-s-line"></i></a>
                           <div class="iq-sub-dropdown">
                              <a class="iq-sub-card" href="#"><img src="{{asset(path: 'assets/images/small/flag-02.png')}}" alt="img-flaf" class="img-fluid mr-2" />French</a>
                              <a class="iq-sub-card" href="#"><img src="{{asset(path: 'assets/images/small/flag-03.png')}}" alt="img-flaf" class="img-fluid mr-2" />Spanish</a>
                              <a class="iq-sub-card" href="#"><img src="{{asset(path: 'assets/images/small/flag-04.png')}}" alt="img-flaf" class="img-fluid mr-2" />Italian</a>
                              <a class="iq-sub-card" href="#"><img src="{{asset(path: 'assets/images/small/flag-05.png')}}" alt="img-flaf" class="img-fluid mr-2" />German</a>
                              <a class="iq-sub-card" href="#"><img src="{{asset(path: 'assets/images/small/flag-06.png')}}" alt="img-flaf" class="img-fluid mr-2" />Japanese</a>
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{asset(path: 'assets/images/user/01.jpg')}}" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{asset(path: 'assets/images/user/02.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{asset(path: 'assets/images/user/03.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{asset(path: 'assets/images/user/04.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{asset(path: 'assets/images/user/05.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                  ...
                  <ul class="navbar-list">
                     <li>
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
                           <img src="{{asset(path: 'assets/images/user/1.jpg')}}" class="img-fluid rounded mr-3" alt="user">
                           <div class="caption">
...
<!-- Mirrored from templates.iqonic.design/vito/html/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 14:22:53 GMT -->
</html>
